...
export const analyticsDemoPresets = Object.fromEntries(presetList.map(preset => [preset.key, preset]));
const presetLabels = {
    cartesian: '柱状/折线/面积',
    pie: '饼图/环图',
    funnel: '漏斗图',
...
export const analyticsDemoOptions = presetList.map(preset => ({
    key: preset.key,
    label: presetLabels[preset.key] || preset.key,
    fileName: preset.fileName,
}));
const presetKeysByKind = {
    bar: 'cartesian',
    line: 'cartesian',
    area: 'cartesian',
    stack_bar: 'cartesian',
