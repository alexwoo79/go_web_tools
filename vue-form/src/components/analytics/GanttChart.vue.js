...
import { TitleComponent, TooltipComponent, GridComponent, LegendComponent, DataZoomComponent, ToolboxComponent, MarkLineComponent, } from 'echarts/components';
...
// ── time helpers ──────────────────────────────────────────────
function floorToDay(ts) { const d = new Date(ts); return +new Date(d.getFullYear(), d.getMonth(), d.getDate()); }
function ceilToDay(ts) { const d = new Date(ts); return +new Date(d.getFullYear(), d.getMonth(), d.getDate() + 1); }
function floorToWeek(ts) { const d = new Date(floorToDay(ts)); const day = d.getDay(); return d.setDate(d.getDate() - day), +d; }
function ceilToWeek(ts) { const d = new Date(floorToDay(ts)); const day = d.getDay(); return d.setDate(d.getDate() + (day === 0 ? 0 : 7 - day)), +d; }
function floorToMonth(ts) { const d = new Date(ts); return +new Date(d.getFullYear(), d.getMonth(), 1); }
function ceilToMonth(ts) { const d = new Date(ts); return +new Date(d.getFullYear(), d.getMonth() + 1, 1); }
function floorToQuarter(ts) { const d = new Date(ts); const q = Math.floor(d.getMonth() / 3); return +new Date(d.getFullYear(), q * 3, 1); }
function ceilToQuarter(ts) { const d = new Date(ts); const q = Math.floor(d.getMonth() / 3); return +new Date(d.getFullYear(), (q + 1) * 3, 1); }
function floorToYear(ts) { return +new Date(new Date(ts).getFullYear(), 0, 1); }
function ceilToYear(ts) { return +new Date(new Date(ts).getFullYear() + 1, 0, 1); }
function floorTo(ts, gran) {
    switch (gran) {
...
function formatTimelineLabel(ts, gran) {
    const d = new Date(ts);
...
function buildGanttDataViewTable(rows, showDesc = true) {
...
function visualBarHeight(laneHeight, preferred) {
...
function readableTextColor(bgHex, isDark) {
...
function surfaceTextColor(isDark) {
    return isDark ? '#e2e8f0' : '#334155';
}
function planStrokeTheme(isDark) {
    return isDark
...
function buildHierRows(tasks, opts) {
    const grouped = {};
    tasks.forEach(t => {
        const p = t.project || '未分组';
        if (!grouped[p])
            grouped[p] = { items: [], minStart: Infinity, maxEnd: -Infinity };
    ...
    const projectOrder = Object.keys(grouped).sort((a, b) => {
        ...
        if (ga.minStart !== gb.minStart)
            return ga.minStart - gb.minStart;
...
function buildOption(tasks, themeName, opts) {
    if (!tasks.length)
        return {};
    ...
    const barRender = (params, api) => {
        ...
        const rect = echarts.graphic.clipRectByRect({ x: s[0], y: s[1] - h / 2, width: e[0] - s[0], height: h }, { x: params.coordSys.x, y: params.coordSys.y, width: params.coordSys.width, height: params.coordSys.height });
        if (!rect)
            return null;
    ...
    return {
        ...
        xAxis: {
            ...
            axisLabel: {
                formatter: (v) => formatTimelineLabel(v, gran),
        ...
        dataZoom: [
            {
                ...
                labelFormatter: (v) => formatTimelineLabel(v, gran),
...
function enterFullscreen() {
    const el = chartEl.value?.closest?.('.gantt-chart-wrap') ?? chartEl.value;
...
/** @type {__VLS_StyleScopedClasses['gantt-chart-wrap']} */ ;
/** @type {__VLS_StyleScopedClasses['gantt-chart-wrap']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "gantt-chart-wrap" },
});
/** @type {__VLS_StyleScopedClasses['gantt-chart-wrap']} */ ;
...
/** @type {__VLS_StyleScopedClasses['gantt-el']} */ ;
if (__VLS_ctx.stats) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "gantt-stats" },
    });
    /** @type {__VLS_StyleScopedClasses['gantt-stats']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "stat-item" },
    });
    /** @type {__VLS_StyleScopedClasses['stat-item']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.b, __VLS_intrinsics.b)({});
    (__VLS_ctx.stats.taskCount);
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "stat-item" },
    });
    /** @type {__VLS_StyleScopedClasses['stat-item']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.b, __VLS_intrinsics.b)({});
    (__VLS_ctx.stats.avgDurationDays.toFixed(1));
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "stat-item" },
    });
    /** @type {__VLS_StyleScopedClasses['stat-item']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.b, __VLS_intrinsics.b)({});
    (__VLS_ctx.stats.totalDurationDay);
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "stat-item" },
    });
    /** @type {__VLS_StyleScopedClasses['stat-item']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.b, __VLS_intrinsics.b)({});
    (__VLS_ctx.stats.maxDurationDay);
    if (__VLS_ctx.stats.hasPlanTotalDuration) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: "stat-item" },
        });
        /** @type {__VLS_StyleScopedClasses['stat-item']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.b, __VLS_intrinsics.b)({});
        (__VLS_ctx.stats.planTotalDurationDay);
    }
}
// @ts-ignore
