...
/** @type {__VLS_StyleScopedClasses['user-banner']} */ ;
...
/** @type {__VLS_StyleScopedClasses['banner-user']} */ ;
/** @type {__VLS_StyleScopedClasses['banner-role']} */ ;
/** @type {__VLS_StyleScopedClasses['form-table']} */ ;
/** @type {__VLS_StyleScopedClasses['cell-title']} */ ;
        ...
        for (const [form] of __VLS_vFor((group.items))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({
                ...{ onClick: (...[$event]) => {
                        ...
                        // @ts-ignore
                        [auth, auth, auth, auth, router, logout, loading, error, error, forms, groupedForms,];
                    } },
                key: (form.Name),
                ...{ class: "table-row" },
            });
