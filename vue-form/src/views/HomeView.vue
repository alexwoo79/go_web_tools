  ...
  <div class="page">
    <header class="site-header">
      ...
      <nav>
        ...
        <a v-if="auth.user" href="/portal" @click.prevent="router.push('/portal')">工作导航</a>
...
.header-user-badge {
  ...
  padding: 0 .8rem;
  border-radius: 999px;
  border: 1px solid rgba(190, 205, 235, .9);
  background: linear-gradient(90deg, #eef4ff 0%, #ebf8f1 100%);
  color: #314667;
  font-size: .92rem;
  font-weight: 700;
}
